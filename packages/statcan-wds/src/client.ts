...
export const DimensionSchema = z.object({
  ...
  dimensionNameEn: z.string().nullable().optional(),
  dimensionNameFr: z.string().nullable().optional(),
  hasUom: z.boolean(),
...
export const FootnoteSchema = z.object({
  footnoteId: z.number(),
  footnotesEn: z.string().nullable().optional(),
  footnotesFr: z.string().nullable().optional(),
...
export const TableMetadataSchema = z.object({
  ...
  cubeTitleEn: z.string().nullable().optional(),
  cubeTitleFr: z.string().nullable().optional(),
  cubeStartDate: z.string().nullable().optional(),
  cubeEndDate: z.string().nullable().optional(),
  frequencyCode: z.number().nullable().optional(),
  nbSeriesCube: z.number().nullable().optional(),
  nbDatapointsCube: z.number().nullable().optional(),
  releaseTime: z.string().nullable().optional(),
  archiveStatusCode: z.string().nullable().optional(),
  archiveStatusEn: z.string().nullable().optional(),
  archiveStatusFr: z.string().nullable().optional(),
...
export const DatapointSchema = z.object({
  ...
  scalarFactorCode: z.number().nullable().optional(),
  symbolCode: z.number().nullable().optional(),
  statusCode: z.number().nullable().optional(),
  securityLevelCode: z.number().nullable().optional(),
  releaseTime: z.string().nullable().optional(),
  frequencyCode: z.number().nullable().optional(),
});
