  ...
  return (
    <main className="flex flex-1 flex-col px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl w-full">
        ...
        {/* Installation */}
        <div className="mb-12">
          <h2 className="text-lg font-medium mb-4 text-fd-foreground">Installation</h2>
          ...
          <p className="mt-3 text-sm text-fd-muted-foreground">
            Note: <code className="font-mono text-xs">zod</code> is a required peer dependency for runtime validation.
          </p>
        </div>

        {/* Packages */}
        <div className="mb-16">
          <h2 className="text-lg font-medium mb-4 text-fd-foreground">Available Packages</h2>
        ...
        {/* Architecture */}
        <div>
          <h2 className="text-lg font-medium mb-4 text-fd-foreground">Architecture &amp; Design</h2>
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-xl border border-fd-border bg-fd-card p-5">
              <h3 className="font-medium text-fd-foreground mb-2">Runtime Validation</h3>
              <p className="text-sm text-fd-muted-foreground leading-relaxed">
            ...
            <div className="rounded-xl border border-fd-border bg-fd-card p-5">
              <h3 className="font-medium text-fd-foreground mb-2">Isomorphic Implementation</h3>
              <p className="text-sm text-fd-muted-foreground leading-relaxed">
            ...
            <div className="rounded-xl border border-fd-border bg-fd-card p-5">
              <h3 className="font-medium text-fd-foreground mb-2">Network Resilience</h3>
              <p className="text-sm text-fd-muted-foreground leading-relaxed">
                Built-in retry mechanisms with exponential backoff. Automatically handles transient 409/429/500 HTTP statuses, transparently respecting <code className="font-mono text-[10px]">Retry-After</code> headers.
              </p>
            </div>
            <div className="rounded-xl border border-fd-border bg-fd-card p-5">
              <h3 className="font-medium text-fd-foreground mb-2">Build Optimization</h3>
              <p className="text-sm text-fd-muted-foreground leading-relaxed">
                Distributed as dual ESM/CJS bundles. Explicitly marked as side-effect free (<code className="font-mono text-[10px]">sideEffects: false</code>) to ensure comprehensive tree-shaking in modern bundlers.
              </p>
            </div>
          </div>
        </div>
